...
A high-precision workbench clamping tool designed to securely hold mechanical workpieces during filing, sawing, and machining operations.
...
- [ ] **Base** - [ ] **Vise Jaw** - [ ] **Sliding Jaw** - [ ] **Screw Spindle** - [ ] **Handle** - [ ] **Tommy Bar** - [ ] **Jaw Plate**
